    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                // Fetch users
                const usersResponse = await fetch('https://online-shop-backend-qpnv.onrender.com/api/auth/admin/users', {
                    headers: {
                ...
                // Fetch orders
                const ordersResponse = await fetch('https://online-shop-backend-qpnv.onrender.com/api/order/admin/orders', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
